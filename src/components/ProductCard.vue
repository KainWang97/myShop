...
<template>
  ...
  >
    <div class="relative overflow-hidden w-full aspect-[3/4] bg-stone-200">
      ...
      <div class="absolute bottom-6 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
        <span class="bg-washi/90 px-6 py-2 text-xs uppercase tracking-widest text-sumi border border-stone-200 backdrop-blur-sm">
          View
        </span>
      </div>
    </div>
    ...
    <div class="text-center space-y-1">
      ...
      <p class="text-xs text-stone-500 tracking-wider uppercase">{{ product.category }}</p>
